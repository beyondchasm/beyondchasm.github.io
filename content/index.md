...
![[Pasted image 20260315230557.png]]

### 매일 뭐라도 만드는 작은물개 스튜디오입니다.
...
<div style="flex:1;min-width:280px;border:1px solid var(--lightgray);padding:20px;border-radius:14px;background:var(--light)">

### ✍️ [[blog/index|블로그 목록]]

개발하면서 배운 것, 생각, 경험을 기록합니다.
